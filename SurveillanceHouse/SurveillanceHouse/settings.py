"""
Django settings for SurveillanceHouse project.
...
SECRET_KEY = 'django-insecure-hb_*i3s@(nkdqws-dmh_q+3s=)_aa(6o@-y=ku)6^=gyc026$p'
...
WSGI_APPLICATION = 'SurveillanceHouse.wsgi.application'
