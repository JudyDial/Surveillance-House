    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certifications', models.ManyToManyField(to='inventory.certification')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_type', models.CharField(blank=True, choices=[('wire-free cameras', 'Wire-Free Cameras'), ('indoor wi-Fi cameras', 'Indoor Wi-Fi Cameras'), ('outdoor wi-Fi cameras', 'Outdoor Wi-Fi Cameras')], max_length=100, null=True)),
                ('model_image', models.ImageField(blank=True, null=True, upload_to='model_images/')),
                ('Item_model', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='inventory.model')),
            ],
        ),
        migrations.CreateModel(
            name='InTheBox',
